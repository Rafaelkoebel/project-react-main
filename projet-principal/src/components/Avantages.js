...
const Avantages = () => {
    return (
        <div className='Avantages'>
            <h2 className=' text-center text-4xl mb-16 mt-20'>Avantages et inconvénient</h2>
            ...
            <div class="grid grid-cols-6 grid-rows-7 gap-4 flex	justify-center  mt-24 ">
                ...
                <div class="col-start-2 col-end-4 row-start-4 flex justify-end mr-4	">
                    <p className='w-2/3 bg-white border-solid border-[3px] border-angular p-0.5 rounded-tl-lg rounded-br-lg text-center min-w-[140px]'> Conçu par Google qui s’occupe du suivi et des mises à jour.</p>
                </div>
                <div class="col-end-6 col-span-2 row-start-5 row-span-1 flex justify-start ml-[3px]">
                    <p className='w-2/3 bg-white border-solid border-[3px] border-angular p-0.5 rounded-tl-lg rounded-br-lg text-center min-w-[140px]'>  TypeScript est plus sécurisé et plus lisible que JavaScript</p>
                </div>
            </div>    
        </div>
    );
